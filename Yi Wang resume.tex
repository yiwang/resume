...
\begin{resume}
    ...
    \textsl{Software Engineer Intern (full time)} \hfill 03/2010 -- Present \vspace{-3mm}\\\vspace{-1mm}%
      \begin{list2}
      \item Design and implement integration of group video/audio/text chat rooms with community site
      \item Work with Java, PHP, MySQL, ActionScript, Flash, Tomcat and Red5 media server
      \item Setup and administrate rackspace cloud server and github repositories
      \end{list2}

    \textbf{Columbia University}, New York, NY \\
    \textsl{Research Assistant (part time)} \hfill 11/2009 -- 12/2009, 02/2010 -- Present \vspace{-3mm}\\\vspace{-1mm}%
      \begin{list2} 
